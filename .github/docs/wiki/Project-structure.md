# Project Structure
    ...
    |   |   |   ├── cho.py        # endpoints available @ https://c.kawata.pw
    |   |   |   ├── map.py        # endpoints available @ https://b.kawata.pw
    |   |   |   └── osu.py        # endpoints available @ https://osu.kawata.pw
    |   |   |
    |   |   ├── v1
    |   |   |   └── api.py          # endpoints available @ https://api.kawata.pw/v1
    |   |   |
    |   |   ├── v2
    |   |   |   ├── clans.py        # endpoints available @ https://api.kawata.pw/v2/clans
    |   |   |   ├── maps.py         # endpoints available @ https://api.kawata.pw/v2/maps
    |   |   |   ├── players.py      # endpoints available @ https://api.kawata.pw/v2/players
    |   |   |   └── scores.py       # endpoints available @ https://api.kawata.pw/v2/scores
    |   |   |
    ...
    ├── tools                 # various tools made throughout kawata.py's history

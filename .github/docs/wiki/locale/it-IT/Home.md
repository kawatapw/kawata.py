# Benvenuto nel wiki di kawata.py

**kawata.py** è un'implementazione del server osu! in fase di sviluppo per sviluppatori di tutti i livelli
di esperienza interessati a ospitare la propria istanza di server privato osu!.

Il progetto è sviluppato principalmente dal team [Kawata](https://kawata.pw/),

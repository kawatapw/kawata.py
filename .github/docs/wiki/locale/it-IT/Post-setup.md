...
![Passaggio 1](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_1.png)
...
![Passaggio 2](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_2.png)
...
![Passaggio 3](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_3.png)
...
![Passaggio 4](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_4.png)

Una volta completati i passaggi precedenti, dovrai aggiungere alcuni record DNS (record A) affinché i domini necessari puntino all'IP su cui kawata.py è in esecuzione.
...
![Passaggio 5](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_5.png)
...
<table>
    <tr>
        ...
        <th>
            <img src="https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_6.png" alt="Passaggio 6">
        </th>
    </tr>
</table>
...
![Passaggio 7](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_7.png)

Ora dovrai creare certificati generati da Cloudflare. Vai su SSL>TLS > Origin Server e clicca su `crea certificato`.

![Passaggio 8](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_8.png)

![Passaggio 9](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_9.png)
...
![Passaggio 10](https://github.com/kawatapw/kawata.py/blob/master/.github/images/ssl_cf_10.png)
...
![Abilitare i dati di geolocalizzazione CF](https://github.com/kawatapw/kawata.py/blob/master/.github/images/cf_geoloc.png)

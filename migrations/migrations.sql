...
# v5.2.4
# hinaDir Admin V2: separate audit log table (does not touch legacy logs)
...
# hinaDir Admin V2: beatmap review work items queue
...
# hinaDir Admin V2: beatmap review discussion comments

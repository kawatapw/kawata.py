...
class SafetyParser(Parser):
    ...
    def parse(self, content: str) -> Dict[str, Any]:
        ...
        packages_scanned = len(scanned_packages) if isinstance(scanned_packages, dict) else 0
    ...
    def _parse_vulnerability(self, vuln: Dict[str, Any], package_name: str = '') -> Dict[str, Any]:
        ...
        installed_version = vuln.get('installed_version', vuln.get('analyzed_version', ''))

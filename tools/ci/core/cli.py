...
def parse_args() -> argparse.Namespace:
    ...
    finish_parser = workflow_subparsers.add_parser('finish', help='Finish workflow or job')
    ...
    generate_parser.add_argument('--artifact-dir', help='Directory containing artifacts')
